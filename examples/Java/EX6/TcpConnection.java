...
// Initial revision
//
// Revision 1.1  2000/10/16 19:42:56  charlesr
// Initial version.
//
...
//                             segment);
    ...
    /* package */ boolean isInterloper(TcpSegment segment)
    {
        return(_address.equals(segment.getSourceAddress()) == false ||
               _port != segment.getSourcePort());
    }

    /* package */ boolean isValidAck(TcpSegment segment)
    {
        return(_address.equals(segment.getSourceAddress()) == true &&
               _port == segment.getSourcePort() &&
